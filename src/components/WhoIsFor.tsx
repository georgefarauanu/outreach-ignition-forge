...
const WhoIsFor = () => {
  ...
  return <section id="who-is-for" className="py-20 lg:py-32 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {targets.map((target, index) => <Card key={index} className="bg-card/50 backdrop-blur-sm border-border hover:shadow-elegant transition-all duration-300 group">
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  {target.benefits.map((benefit, benefitIndex) => <div key={benefitIndex} className="flex items-center space-x-3">
